...
__start = True
current_status = ''
def runActionGroup(actName, times=1, with_stand=False, lock_servos='', path="/userdata/OriginMan/ActionGroups/"): 
    global __end
    global __start
...
def runAction(actNum, lock_servos='', path="/userdata/OriginMan/ActionGroups/"):
    '''
