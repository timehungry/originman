...
save_path = '/userdata/OriginMan/Functions/CameraCalibration/calibration_images/'

#标定参数存储路径(storage path for calibration parameters)
calibration_param_path = '/userdata/OriginMan/Functions/CameraCalibration/calibration_param'

#映射参数存储路径(storage path for mapping parameters)
map_param_path = '/userdata/OriginMan/Functions/CameraCalibration/map_param'
